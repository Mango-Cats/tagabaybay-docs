...
as phonetic structures are varied and dependent on surrounding
...
The phonological vowel space of Filipino speakers are varied and dependent on prestige.
Considering a focus on Basilectal speech, this vowel space is more limited jvfjn

Provided an AlignedString, each index contains the tuples of grapheme and phoneme
tokens. The IPA phonemes map to a certain corresponding default Filipino grapheme but
considering the diversity of certain vowel pronunciations in English, grapheme dependent
context-sensitive rules are made to adapt the loanword into its equivalent Filipino
orthography(??) as referenced from Komisyon ng Wikang Filipino's MMP. 
