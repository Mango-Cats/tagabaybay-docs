...
related but distinct problems. FST cascades with Optimality-Theoretic
...
\begin{itemize}
      \item We formalize orthographic nativization as prioritized grapheme-level rewrite
            transduction, demonstrating that prescriptive linguistic rules can be
            operationalized as an interpretable pipeline without large parallel corpora.

      \item Using Filipino as a testbed, we implement and evaluate the framework on real
